...
async function loadMyModel() {
  console.log("my model loading..");

  // clear the model variable
  model = undefined;
  model = await tf.loadLayersModel("./mymodel/my-model.json");
...
$("#predict-button").click(async function () {
  ...
  let predictions_1 = model.predict(tensor);

  let result = tf.argMax(predictions_1, 1);
  console.log(result.toString());

  let guess = result.toString();
  let arr = guess.split('');
...
function displayLabel(data) {
  ...
  $(".prediction-text").html("Predicting you draw <b>" + guess_value + "</b>")
}
